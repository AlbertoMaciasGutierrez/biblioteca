...
#Esta función sireve para que cualquier aplicación que importe MySQLdb o_mysql, sin saberlo, utilizará pymysql.
...
INSTALLED_APPS = [
    ...
    'peliculas',
    'rest_framework',
    'django_cleanup.apps.CleanupConfig',    #Para eliminar elementos antiguos
]
